<?php
  ...
  $location = "";
   ...
   if (isset($_POST) & !empty($_POST)) {
     ...
     $sql = "INSERT INTO products (name, category, price, description, thumb) VALUES ('$name1', '$productcategory', '$productprice', '$productdescription', '$location$name')";
...
<br>
            <div class="form-group">
              ...
              <input type="number" name="productprice" id="productprice"class="form-group" placeholder="Product Price">
            </div>
          </div>
          <div class="form-group">
